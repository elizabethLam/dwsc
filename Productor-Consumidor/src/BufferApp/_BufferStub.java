...
public class _BufferStub extends org.omg.CORBA.portable.ObjectImpl implements BufferApp.Buffer
{
  ...
  public boolean getBufferLength (org.omg.CORBA.StringHolder elemento)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getBufferLength", true);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                elemento.value = $in.read_string ();
                return $result;
                ...
                return getBufferLength (elemento        );
            } finally {
                _releaseReply ($in);
            }
  } // getBufferLength
  ...
  public boolean setBufferLength (String elemento)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setBufferLength", true);
                $out.write_string (elemento);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
                ...
                return setBufferLength (elemento        );
            } finally {
                _releaseReply ($in);
            }
  } // setBufferLength
