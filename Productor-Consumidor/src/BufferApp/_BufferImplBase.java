                ...
                implements BufferApp.Buffer, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getBufferLength", new java.lang.Integer (4));
    _methods.put ("setBufferLength", new java.lang.Integer (5));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // BufferApp/Buffer/getBufferLength
       {
         org.omg.CORBA.StringHolder elemento = new org.omg.CORBA.StringHolder ();
         boolean $result = false;
         $result = this.getBufferLength (elemento);
         out = $rh.createReply();
         out.write_boolean ($result);
         out.write_string (elemento.value);
         break;
       ...
       case 5:  // BufferApp/Buffer/setBufferLength
       {
         String elemento = in.read_string ();
         boolean $result = false;
         $result = this.setBufferLength (elemento);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
